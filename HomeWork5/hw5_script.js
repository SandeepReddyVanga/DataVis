/*
 * If there is an error, insert an error message in
  the HTML
...
function symbolMap() {
    ...
    var radius = d3.scale.sqrt().range([4, 14]);
    ...
    var value = function(d) { return d.mag; };
    ...
    function chart(id) {
        ...
        projection = projection
                        .scale((bbox.width + 1) / 2.1 / Math.PI)
                        .translate([bbox.width/ 2, bbox.height / 1.5])
                        .precision(.1);//scale(bbox.width);
       ...
       var color = d3.scale.threshold()
        ...
        g.call(xAxis).append("text")
                    .attr("class", "caption")
                    .attr("y", -6)
                    .text("Depth of Earthquake (in km)");
    ...
    function showHighlight(d) {
        ...
        updateLog("Earthquake of magnitude " + d.mag + 
                    ", depth " + d.depth + " km " +

                    "rocks " + d.place + " on " + d.time);
    }
