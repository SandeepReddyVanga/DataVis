...
//   //   $('slider').onchange = function() { draw_map(this.value); };
//   //   };
...
//   d3.select("#imports_map")
//           .on("click", function(d,i) {
//             draw_map("./ProjectDataSet/fertilizer_imports_timeseries_volume_byCountry.csv")
//           })
//   d3.select("#exports_map")
//       .on("click", function(d,i) {
//           draw_map(id,"./ProjectDataSet/fertilizer_exports_timeseries_volume_byCountry.csv")
//       })
...
function draw_map_exports(){
  ...
  var format = function(d) {
    d = d / 1000000;
    return d3.format(',.01f')(d) + 'Millions';
      }
